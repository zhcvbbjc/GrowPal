...
var sql_db_exports = /* @__PURE__ */ require_runtime.__exportAll({ SqlDatabase: () => SqlDatabase });
/**
...
*/
var SqlDatabase = class SqlDatabase extends _langchain_core_load_serializable.Serializable {
