...
*/
var QuerySqlTool = class extends Tool {
	static lc_name() {
		return "QuerySqlTool";
	}
	name = "query-sql";
...
* returned.
*/
var InfoSqlTool = class extends Tool {
	static lc_name() {
		return "InfoSqlTool";
	}
	name = "info-sql";
...
* in the database.
*/
var ListTablesSqlTool = class extends Tool {
	static lc_name() {
...
* prediction.
*/
var QueryCheckerTool = class extends Tool {
	static lc_name() {
...
//#endregion
export { InfoSqlTool, ListTablesSqlTool, QueryCheckerTool, QuerySqlTool, sql_exports };
