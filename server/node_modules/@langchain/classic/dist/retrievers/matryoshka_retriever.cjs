...
*/
var MatryoshkaRetriever = class extends _langchain_core_vectorstores.VectorStoreRetriever {
	smallK = 50;
	largeK = 8;
	...
	*/
	_rankByLargeEmbeddings(embeddedQuery, smallResults) {
		...
		switch (this.searchType) {
			case "cosine":
				func = () => (0, _langchain_core_utils_math.cosineSimilarity)([embeddedQuery], largeEmbeddings);
				break;
			case "innerProduct":
				func = () => (0, _langchain_core_utils_math.innerProduct)([embeddedQuery], largeEmbeddings);
				break;
			case "euclidean":
				func = () => (0, _langchain_core_utils_math.euclideanDistance)([embeddedQuery], largeEmbeddings);
				break;
