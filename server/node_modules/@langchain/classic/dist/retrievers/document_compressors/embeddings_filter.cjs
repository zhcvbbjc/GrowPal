...
var embeddings_filter_exports = /* @__PURE__ */ require_runtime.__exportAll({ EmbeddingsFilter: () => EmbeddingsFilter });
/**
...
var EmbeddingsFilter = class extends require_retrievers_document_compressors_index.BaseDocumentCompressor {
	...
	*/
	similarityFn = _langchain_core_utils_math.cosineSimilarity;
	/**
