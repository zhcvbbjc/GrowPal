...
*/
var BooleanLiteralHandler = class extends require_base.NodeHandler {
	/**
	...
	*/
	async accepts(node) {
		if (require_base.ASTParser.isBooleanLiteral(node)) return node;
		else return false;
	}
	/**
...
//# sourceMappingURL=boolean_literal_handler.cjs.map