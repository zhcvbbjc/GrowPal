...
var openai_files_exports = /* @__PURE__ */ require_runtime.__exportAll({ OpenAIFiles: () => OpenAIFiles });
var OpenAIFiles = class extends _langchain_core_load_serializable.Serializable {
	lc_namespace = ["langchain", "experimental"];
	oaiClient;
	constructor(fields) {
		super(fields);
		this.oaiClient = fields?.client ?? new _langchain_openai.OpenAIClient(fields?.clientOptions);
	}
	/**
	* Upload file
