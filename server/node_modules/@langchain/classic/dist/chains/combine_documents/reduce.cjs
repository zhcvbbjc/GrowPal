...
var reduce_exports = /* @__PURE__ */ require("../../_virtual/_rolldown/runtime.cjs").__exportAll({
...
function splitListOfDocs(docs, lengthFunc, tokenMax) {
	...
	for (const doc of docs) {
		...
		if (lengthFunc(subResultDocs) > tokenMax) {
...
async function collapseDocs(docs, combineDocumentFunc) {
	return {
		pageContent: await combineDocumentFunc(docs),
