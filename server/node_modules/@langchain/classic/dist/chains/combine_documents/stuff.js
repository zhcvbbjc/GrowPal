import { DEFAULT_DOCUMENT_PROMPT, DOCUMENTS_KEY, formatDocuments } from "./base.js";
...
*/
async function createStuffDocumentsChain({ llm, prompt, outputParser = new StringOutputParser(), documentPrompt = DEFAULT_DOCUMENT_PROMPT, documentSeparator = "\n\n" }) {
	if (!prompt.inputVariables.includes("context")) throw new Error(`Prompt must include a "${DOCUMENTS_KEY}" variable`);
