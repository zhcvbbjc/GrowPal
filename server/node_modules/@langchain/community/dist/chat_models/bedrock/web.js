		...
		if (provider === "anthropic" || provider === "cohere" || provider === "meta" || provider === "mistral") {
			...
			for await (const chunk of this._readChunks(reader)) {
				...
				if (body.bytes !== void 0) {
					...
					if (this.usesMessagesApi) {
						const chunk = BedrockLLMInputOutputAdapter.prepareMessagesOutput(provider, chunkResult, { coerceContentToString: !toolsInParams });
						...
						if (finalMetrics != null && typeof finalMetrics === "object" && isAIMessage(chunk.message)) chunk.message.usage_metadata = {
