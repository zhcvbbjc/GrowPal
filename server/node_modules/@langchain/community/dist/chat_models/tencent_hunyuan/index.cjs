...
var tencent_hunyuan_exports = /* @__PURE__ */ require_runtime.__exportAll({ ChatTencentHunyuan: () => ChatTencentHunyuan });
/**
...
* ```
*/
var ChatTencentHunyuan = class extends require_base.ChatTencentHunyuan {
	constructor(fields) {
		super({
			...fields,
