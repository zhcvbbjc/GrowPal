...
var aleph_alpha_exports = /* @__PURE__ */ require_runtime.__exportAll({ AlephAlpha: () => AlephAlpha });
/**
...
* Aleph Alpha model.
*/
var AlephAlpha = class extends _langchain_core_language_models_llms.LLM {
	...
	aleph_alpha_api_key = (0, _langchain_core_utils_env.getEnvironmentVariable)("ALEPH_ALPHA_API_KEY");
	stop;
