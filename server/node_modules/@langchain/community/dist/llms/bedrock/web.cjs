...
var web_exports = /* @__PURE__ */ require_runtime.__exportAll({ Bedrock: () => Bedrock });
/**
...
*/
var Bedrock = class extends _langchain_core_language_models_llms.LLM {
	...
	*/
	async _call(prompt, options, runManager) {
		...
		return require_index.BedrockLLMInputOutputAdapter.prepareOutput(provider, json);
	}
