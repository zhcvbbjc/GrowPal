...
let pyodide = require("pyodide");
//#region src/experimental/tools/pyinterpreter.ts
var pyinterpreter_exports = /* @__PURE__ */ require_runtime.__exportAll({ PythonInterpreterTool: () => PythonInterpreterTool });
var PythonInterpreterTool = class extends _langchain_core_tools.Tool {
	static lc_name() {
