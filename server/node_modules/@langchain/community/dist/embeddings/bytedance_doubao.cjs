...
var bytedance_doubao_exports = /* @__PURE__ */ require_runtime.__exportAll({ ByteDanceDoubaoEmbeddings: () => ByteDanceDoubaoEmbeddings });
var ByteDanceDoubaoEmbeddings = class extends _langchain_core_embeddings.Embeddings {
	model;
	batchSize = 24;
	stripNewLines = true;
	apiKey;
	constructor(fields) {
		...
		const apiKey = fieldsWithDefaults?.apiKey ?? (0, _langchain_core_utils_env.getEnvironmentVariable)("ARK_API_KEY");
