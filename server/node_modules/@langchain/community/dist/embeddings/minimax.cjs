...
var minimax_exports = /* @__PURE__ */ require_runtime.__exportAll({ MinimaxEmbeddings: () => MinimaxEmbeddings });
/**
...
* ```
*/
var MinimaxEmbeddings = class extends _langchain_core_embeddings.Embeddings {
	modelName = "embo-01";
	model = "embo-01";
	batchSize = 512;
	stripNewLines = true;
