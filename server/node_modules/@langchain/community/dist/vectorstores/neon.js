...
var neon_exports = /* @__PURE__ */ __exportAll({ NeonPostgres: () => NeonPostgres });
/**
...
var NeonPostgres = class NeonPostgres extends VectorStore {
	...
	*/
    ...
    `;
		...
		return await neon(this.neonConnectionString).query(queryString, flatValues);
	}
	/**
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
      ...
      LIMIT $2;`;
		const documents = await neon(this.neonConnectionString).query(queryString, parameters);
		const results = [];
