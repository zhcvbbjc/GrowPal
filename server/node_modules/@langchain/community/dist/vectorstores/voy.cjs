...
var voy_exports = /* @__PURE__ */ require_runtime.__exportAll({ VoyVectorStore: () => VoyVectorStore });
/**
...
*/
var VoyVectorStore = class VoyVectorStore extends _langchain_core_vectorstores.VectorStore {
	client;
	numDimensions = null;
	docstore = [];
	_vectorstoreType() {
