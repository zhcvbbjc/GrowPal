...
var cassandra_exports = /* @__PURE__ */ __exportAll({ CassandraStore: () => CassandraStore });
/**
...
var CassandraStore = class CassandraStore extends VectorStore {
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		return maximalMarginalRelevance(queryEmbedding, queryResults.map((doc) => doc[0].metadata[this.embeddingColumnAlias]), lambda, k).map((idx) => {
