...
var momento_vector_index_exports = /* @__PURE__ */ __exportAll({ MomentoVectorIndex: () => MomentoVectorIndex });
/**
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		if (response instanceof VectorSearchAndFetchVectors.Success) {
			...
			return maximalMarginalRelevance(queryEmbedding, hits.map((hit) => hit.vector), options.lambda, options.k).map((index) => {
