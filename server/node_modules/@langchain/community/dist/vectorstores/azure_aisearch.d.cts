import { KeyCredential } from "../node_modules/.pnpm/@azure_core-auth@1.10.1/node_modules/@azure/core-auth/dist/esm/keyCredential.cjs";
import { TokenCredential } from "../node_modules/.pnpm/@azure_core-auth@1.10.1/node_modules/@azure/core-auth/dist/esm/tokenCredential.cjs";
...
declare const AzureAISearchQueryType: {
  /** Vector search. */readonly Similarity: "similarity"; /** Hybrid full text and vector search. */
  readonly SimilarityHybrid: "similarity_hybrid"; /** Hybrid full text and vector search with semantic ranking. */
...
type AzureAISearchFilterType = {
  /** OData filter. */filterExpression?: string; /** Determines whether or not filters are applied before or after the vector search is performed. */
  vectorFilterMode?: VectorFilterMode; /** Determines whether or not to include the embeddings in the search results. */
