...
var myscale_exports = /* @__PURE__ */ require_runtime.__exportAll({ MyScaleStore: () => MyScaleStore });
/**
...
* texts or documents.
*/
var MyScaleStore = class MyScaleStore extends _langchain_core_vectorstores.VectorStore {
	client;
	indexType;
	indexParam;
	columnMap;
