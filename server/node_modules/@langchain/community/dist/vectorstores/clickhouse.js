...
var clickhouse_exports = /* @__PURE__ */ __exportAll({ ClickHouseStore: () => ClickHouseStore });
/**
...
var ClickHouseStore = class ClickHouseStore extends VectorStore {
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		...
		return (await (await this.client.query({ query: queryStr })).json()).data.map((item) => [new Document({
