...
var vercel_postgres_exports = /* @__PURE__ */ require_runtime.__exportAll({ VercelPostgres: () => VercelPostgres });
/**
...
*/
var VercelPostgres = class VercelPostgres extends _langchain_core_vectorstores.VectorStore {
	tableName;
	idColumnName;
	vectorColumnName;
	contentColumnName;
	...
	*/
	static async initialize(embeddings, config) {
		const pool = config?.pool ?? (0, _vercel_postgres.createPool)({
			maxUses: 1,
