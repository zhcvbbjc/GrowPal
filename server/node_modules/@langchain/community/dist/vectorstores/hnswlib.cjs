...
var hnswlib_exports = /* @__PURE__ */ require_runtime.__exportAll({ HNSWLib: () => HNSWLib });
/**
...
*/
var HNSWLib = class HNSWLib extends _langchain_core_vectorstores.SaveableVectorStore {
	_index;
	docstore;
	args;
	_vectorstoreType() {
