...
var hanavector_exports = /* @__PURE__ */ __exportAll({ HanaDB: () => HanaDB });
...
var HanaDB = class HanaDB extends VectorStore {
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		return maximalMarginalRelevance(queryEmbedding, docs.map((doc) => doc[2]), lambda, k).map((index) => docs[index][0]);
	}
};
//#endregion
