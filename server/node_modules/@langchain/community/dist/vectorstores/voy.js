...
var voy_exports = /* @__PURE__ */ __exportAll({ VoyVectorStore: () => VoyVectorStore });
/**
...
*/
var VoyVectorStore = class VoyVectorStore extends VectorStore {
	client;
	numDimensions = null;
	docstore = [];
	_vectorstoreType() {
	...
	*/
	async similaritySearchVectorWithScore(query, k) {
		...
		return this.client.search(new Float32Array(query), itemsToQuery).neighbors.map(({ id }, idx) => [this.docstore[parseInt(id, 10)].document, idx]);
	}
	/**
...
//#endregion
export { VoyVectorStore, voy_exports };

//# sourceMappingURL=voy.js.map