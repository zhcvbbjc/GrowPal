...
let usearch = require("usearch");
//#region src/vectorstores/usearch.ts
var usearch_exports = /* @__PURE__ */ require_runtime.__exportAll({ USearch: () => USearch });
/**
...
*/
var USearch = class extends _langchain_core_vectorstores.SaveableVectorStore {
	_index;
	_mapping;
	docstore;
	args;
