...
var tigris_exports = /* @__PURE__ */ require_runtime.__exportAll({ TigrisVectorStore: () => TigrisVectorStore });
/**
...
*/
var TigrisVectorStore = class TigrisVectorStore extends _langchain_core_vectorstores.VectorStore {
	index;
	_vectorstoreType() {
		return "tigris";
	}
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		...
		if (!result) return [];
		return result.map(([document, score]) => [new _langchain_core_documents.Document({
