...
var azure_aisearch_exports = /* @__PURE__ */ __exportAll({
...
var AzureAISearchVectorStore = class AzureAISearchVectorStore extends VectorStore {
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		return maximalMarginalRelevance(queryEmbedding, docs.map((doc) => doc[0].metadata.embedding), lambda, k).map((index) => {
