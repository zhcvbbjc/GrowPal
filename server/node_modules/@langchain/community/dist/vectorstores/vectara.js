...
var vectara_exports = /* @__PURE__ */ __exportAll({
...
* class.
*/
var VectaraStore = class VectaraStore extends VectorStore {
	get lc_secrets() {
		return {
	...
	constructor(args) {
		...
		const corpusId = args.corpusId ?? getEnvironmentVariable("VECTARA_CORPUS_ID")?.split(",").map((id) => {
			const num = Number(id);
...
//#endregion
export { DEFAULT_FILTER, VectaraStore, vectara_exports };
