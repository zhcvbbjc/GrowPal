...
var vespa_exports = /* @__PURE__ */ require_runtime.__exportAll({ VespaRetriever: () => VespaRetriever });
/**
...
var VespaRetriever = class extends require_base.RemoteRetriever {
	...
	*/
	processJsonResponse(json) {
		return json.root.children.map((doc) => new _langchain_core_documents.Document({
