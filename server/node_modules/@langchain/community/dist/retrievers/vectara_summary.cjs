...
var vectara_summary_exports = /* @__PURE__ */ require_runtime.__exportAll({ VectaraSummaryRetriever: () => VectaraSummaryRetriever });
var VectaraSummaryRetriever = class extends _langchain_core_retrievers.BaseRetriever {
	static lc_name() {
	...
	async _getRelevantDocuments(query, _callbacks) {
		...
		if (this.summaryConfig.enabled) docs.push(new _langchain_core_documents.Document({
