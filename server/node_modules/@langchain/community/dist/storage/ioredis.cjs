...
var ioredis_exports = /* @__PURE__ */ require_runtime.__exportAll({ RedisByteStore: () => RedisByteStore });
/**
...
* ```
*/
var RedisByteStore = class extends _langchain_core_stores.BaseStore {
	...
	*/
	async mget(keys) {
		...
		return (await this.client.mgetBuffer(prefixedKeys)).map((value) => {
			if (!value) return;
			else return value;
		});
	}
