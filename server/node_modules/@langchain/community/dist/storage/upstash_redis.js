...
var upstash_redis_exports = /* @__PURE__ */ __exportAll({ UpstashRedisStore: () => UpstashRedisStore });
/**
...
* ```
*/
var UpstashRedisStore = class extends BaseStore {
	...
	constructor(fields) {
		...
		else if (fields.config) this.client = new Redis(fields.config);
...
//#endregion
export { UpstashRedisStore, upstash_redis_exports };
