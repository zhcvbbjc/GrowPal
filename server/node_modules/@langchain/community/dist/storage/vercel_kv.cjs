...
var vercel_kv_exports = /* @__PURE__ */ require_runtime.__exportAll({ VercelKVStore: () => VercelKVStore });
/**
...
* ```
*/
var VercelKVStore = class extends _langchain_core_stores.BaseStore {
	...
	constructor(fields) {
		super(fields);
		this.client = fields?.client ?? _vercel_kv.kv;
		this.ttl = fields?.ttl;
