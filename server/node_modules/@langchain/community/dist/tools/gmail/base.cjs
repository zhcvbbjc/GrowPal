...
var GmailBaseTool = class extends _langchain_core_tools.StructuredTool {
	name = "Gmail";
	...
	constructor({ credentials, scopes } = {
		credentials: {
			clientEmail: (0, _langchain_core_utils_env.getEnvironmentVariable)("GMAIL_CLIENT_EMAIL"),
			privateKey: (0, _langchain_core_utils_env.getEnvironmentVariable)("GMAIL_PRIVATE_KEY"),
			keyfile: (0, _langchain_core_utils_env.getEnvironmentVariable)("GMAIL_KEYFILE"),
			subject: (0, _langchain_core_utils_env.getEnvironmentVariable)("GMAIL_SUBJECT")
		},
