...
var aiplugin_exports = /* @__PURE__ */ require_runtime.__exportAll({ AIPluginTool: () => AIPluginTool });
/**
...
*/
var AIPluginTool = class AIPluginTool extends _langchain_core_tools.Tool {
	static lc_name() {
		return "AIPluginTool";
	}
	_name;
