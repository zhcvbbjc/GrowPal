...
var bingserpapi_exports = /* @__PURE__ */ require_runtime.__exportAll({ BingSerpAPI: () => BingSerpAPI });
/**
...
*/
var BingSerpAPI = class extends _langchain_core_tools.Tool {
	static lc_name() {
		return "BingSerpAPI";
	}
	/**
	...
	*/
	...
	key;
	params;
	constructor(apiKey = (0, _langchain_core_utils_env.getEnvironmentVariable)("BingApiKey"), params = {}) {
		super(...arguments);
	...
	async _call(input) {
		...
		const results = (await response.json()).webPages.value;
