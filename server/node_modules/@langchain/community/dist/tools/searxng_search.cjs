...
var searxng_search_exports = /* @__PURE__ */ require_runtime.__exportAll({ SearxngSearch: () => SearxngSearch });
/**
...
* ```
*/
var SearxngSearch = class extends _langchain_core_tools.Tool {
	static lc_name() {
	...
	*/
	constructor({ apiBase, params, headers }) {
		super(...arguments);
		this.apiBase = (0, _langchain_core_utils_env.getEnvironmentVariable)("SEARXNG_API_BASE") || apiBase;
		this.headers = {
