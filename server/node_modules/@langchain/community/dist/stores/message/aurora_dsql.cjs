...
var aurora_dsql_exports = /* @__PURE__ */ require_runtime.__exportAll({ AuroraDsqlChatMessageHistory: () => AuroraDsqlChatMessageHistory });
/**
...
* ```
*/
var AuroraDsqlChatMessageHistory = class extends _langchain_core_chat_history.BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
	...
	*/
	...
	async addMessage(message) {
		...
		const map = (0, _langchain_core_messages.mapChatMessagesToStoredMessages)([message])[0];
