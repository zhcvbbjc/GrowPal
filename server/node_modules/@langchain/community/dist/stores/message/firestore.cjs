...
var firestore_exports = /* @__PURE__ */ require_runtime.__exportAll({ FirestoreChatMessageHistory: () => FirestoreChatMessageHistory });
/**
...
* ```
*/
var FirestoreChatMessageHistory = class extends _langchain_core_chat_history.BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
	...
	*/
	async getMessages() {
		...
		return (0, _langchain_core_messages.mapStoredMessagesToChatMessages)(response);
	}
	/**
