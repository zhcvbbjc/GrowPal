...
var planetscale_exports = /* @__PURE__ */ __exportAll({ PlanetScaleChatMessageHistory: () => PlanetScaleChatMessageHistory });
/**
...
var PlanetScaleChatMessageHistory = class extends BaseListChatMessageHistory {
	...
	*/
	async getMessages() {
		...
		return mapStoredMessagesToChatMessages((await this.connection.execute(query, params)).rows.map((message) => {
			const data = {
