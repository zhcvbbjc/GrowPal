...
var aurora_dsql_exports = /* @__PURE__ */ __exportAll({ AuroraDsqlChatMessageHistory: () => AuroraDsqlChatMessageHistory });
/**
...
var AuroraDsqlChatMessageHistory = class extends BaseListChatMessageHistory {
	...
	*/
	...
	async getMessages() {
		...
		return mapStoredMessagesToChatMessages((await this.pool.query(query, [this.sessionId])).rows.map((row) => {
