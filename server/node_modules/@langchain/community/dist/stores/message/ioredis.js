...
var ioredis_exports = /* @__PURE__ */ __exportAll({ RedisChatMessageHistory: () => RedisChatMessageHistory });
/**
...
var RedisChatMessageHistory = class extends BaseListChatMessageHistory {
	...
	*/
	async getMessages() {
		return mapStoredMessagesToChatMessages((await this.client.lrange(this.sessionId, 0, -1)).reverse().map((message) => JSON.parse(message)));
	}
	/**
