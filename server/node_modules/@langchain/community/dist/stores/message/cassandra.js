...
var cassandra_exports = /* @__PURE__ */ __exportAll({ CassandraChatMessageHistory: () => CassandraChatMessageHistory });
/**
...
var CassandraChatMessageHistory = class extends BaseListChatMessageHistory {
	...
	*/
	async getMessages() {
		...
		return mapStoredMessagesToChatMessages((await this.cassandraTable.select([this.colMessageType, this.colData], [{
			name: "session_id",
	...
	*/
	async ensureTable() {
		...
		this.cassandraTable = await new CassandraTable({
			...this.options,
