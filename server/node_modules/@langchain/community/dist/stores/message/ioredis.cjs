...
var ioredis_exports = /* @__PURE__ */ require_runtime.__exportAll({ RedisChatMessageHistory: () => RedisChatMessageHistory });
/**
...
* ```
*/
var RedisChatMessageHistory = class extends _langchain_core_chat_history.BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
	...
	*/
	async getMessages() {
		return (0, _langchain_core_messages.mapStoredMessagesToChatMessages)((await this.client.lrange(this.sessionId, 0, -1)).reverse().map((message) => JSON.parse(message)));
	}
	/**
