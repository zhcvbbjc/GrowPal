...
var serpapi_exports = /* @__PURE__ */ require_runtime.__exportAll({ SerpAPILoader: () => SerpAPILoader });
/**
...
* ```
*/
var SerpAPILoader = class extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	apiKey;
	searchQuery;
	constructor(params) {
		super();
		const { apiKey = (0, _langchain_core_utils_env.getEnvironmentVariable)("SERPAPI_API_KEY"), q } = params;
