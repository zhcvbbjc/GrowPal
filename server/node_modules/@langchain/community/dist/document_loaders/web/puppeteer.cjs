...
var puppeteer_exports = /* @__PURE__ */ require_runtime.__exportAll({ PuppeteerWebBaseLoader: () => PuppeteerWebBaseLoader });
/**
...
* ```
*/
var PuppeteerWebBaseLoader = class PuppeteerWebBaseLoader extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	options;
	...
	*/
	static async _screenshot(url, options) {
		...
		return new _langchain_core_documents.Document({
			pageContent: (await page.screenshot()).toString("base64"),
			metadata: { source: url }
		});
	}
	/**
