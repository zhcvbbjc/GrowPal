...
var playwright_exports = /* @__PURE__ */ require_runtime.__exportAll({ PlaywrightWebBaseLoader: () => PlaywrightWebBaseLoader });
/**
...
*/
var PlaywrightWebBaseLoader = class PlaywrightWebBaseLoader extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	options;
