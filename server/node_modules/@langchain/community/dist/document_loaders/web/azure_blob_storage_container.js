...
var azure_blob_storage_container_exports = /* @__PURE__ */ __exportAll({ AzureBlobStorageContainerLoader: () => AzureBlobStorageContainerLoader });
/**
...
var AzureBlobStorageContainerLoader = class extends BaseDocumentLoader {
	...
	*/
	async load() {
		const containerClient = BlobServiceClient.fromConnectionString(this.connectionString, { userAgentOptions: { userAgentPrefix: "langchainjs-blob-storage-container" } }).getContainerClient(this.container);
		let docs = [];
