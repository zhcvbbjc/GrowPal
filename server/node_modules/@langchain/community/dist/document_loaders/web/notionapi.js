...
var notionapi_exports = /* @__PURE__ */ __exportAll({
	...
	*/
	async loadBlock(block) {
		...
		if (block.has_children) {
			...
			mdBlock.children = await this.loadBlocks(await this.caller.call(() => getBlockChildren(this.notionClient, block_id, null)));
		}
		return mdBlock;
	}
	/**
