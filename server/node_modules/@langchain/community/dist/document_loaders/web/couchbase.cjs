...
var couchbase_exports = /* @__PURE__ */ require_runtime.__exportAll({ CouchbaseDocumentLoader: () => CouchbaseDocumentLoader });
/**
* loader for couchbase document
*/
var CouchbaseDocumentLoader = class extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	cluster;
	query;
	pageContentFields;
	metadataFields;
