...
import * as _notionhq_client0 from "@notionhq/client";
...
declare const isPageResponse: (res: GetResponse) => res is _notionhq_client0.DataSourceObjectResponse | _notionhq_client0.DatabaseObjectResponse | _notionhq_client0.PageObjectResponse | _notionhq_client0.PartialBlockObjectResponse | _notionhq_client0.PartialDataSourceObjectResponse | _notionhq_client0.PartialDatabaseObjectResponse | _notionhq_client0.PartialPageObjectResponse | _notionhq_client0.BlockObjectResponse;
declare const isDatabaseResponse: (res: GetResponse) => res is _notionhq_client0.DataSourceObjectResponse | _notionhq_client0.DatabaseObjectResponse | _notionhq_client0.PageObjectResponse | _notionhq_client0.PartialBlockObjectResponse | _notionhq_client0.PartialDataSourceObjectResponse | _notionhq_client0.PartialDatabaseObjectResponse | _notionhq_client0.PartialPageObjectResponse | _notionhq_client0.BlockObjectResponse;
declare const isErrorResponse: (res: GetResponse) => res is APIResponseError;
declare const isPage: (res: GetResponse) => res is _notionhq_client0.PageObjectResponse;
declare const isDatabase: (res: GetResponse) => res is _notionhq_client0.DatabaseObjectResponse;
