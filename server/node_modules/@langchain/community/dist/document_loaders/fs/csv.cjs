...
var csv_exports = /* @__PURE__ */ require_runtime.__exportAll({ CSVLoader: () => CSVLoader });
/**
...
*/
var CSVLoader = class extends _langchain_classic_document_loaders_fs_text.TextLoader {
	options = {};
	...
	*/
	async parse(raw) {
		...
		const parsed = dsvFormat(separator).parse(raw.trim());
		if (column !== void 0) {
