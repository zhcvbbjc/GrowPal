...
let srt_parser_2 = require("srt-parser-2");
srt_parser_2 = require_runtime.__toESM(srt_parser_2);
//#region src/document_loaders/fs/srt.ts
var srt_exports = /* @__PURE__ */ require_runtime.__exportAll({ SRTLoader: () => SRTLoader });
/**
...
* ```
*/
var SRTLoader = class extends _langchain_classic_document_loaders_fs_text.TextLoader {
	...
	*/
	async parse(raw) {
		return [new srt_parser_2.default().fromSrt(raw).map((srt) => srt.text).filter(Boolean).join(" ")];
	}
};
//#endregion
