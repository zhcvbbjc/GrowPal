...
var upstash_ratelimit_exports = /* @__PURE__ */ __exportAll({
...
*/
var UpstashRatelimitHandler = class UpstashRatelimitHandler extends BaseCallbackHandler {
	...
	*/
	async handleLLMStart(_llm, _prompts, _runId, _parentRunId, _extraParams, _tags, _metadata, _name) {
		if (this.tokenRatelimit) {
			...
			if ((typeof result === "number" ? result : result.remaining) <= 0) throw new UpstashRatelimitError("Token limit reached!", "token");
		}
	}
	/**
...
//#endregion
export { UpstashRatelimitError, UpstashRatelimitHandler, upstash_ratelimit_exports };

//# sourceMappingURL=upstash_ratelimit.js.map