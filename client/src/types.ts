...
export type Screen = 'home' | 'community' | 'chat' | 'messages' | 'profile' | 'LoginPage' | 'search' | 'searchRecommend' | 'userPage' | 'userSearch' | 'postDetail' | 'questionDetail' | 'settings' | 'profileSettings' | 'learn' | 'map';
